...
class StorageMetadata:
    ...
    def __init__(self, model_id: str, input_schema: Schema, output_schema: Schema, 
                 input_tensor_name: str = "input", output_tensor_name: str = "output", 
                 observations: int = 0, recorded_inferences: bool = False) -> None:
