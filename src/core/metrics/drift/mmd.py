...
@functools.cache
def _import_goodpoints():  # noqa: ANN202
    """Import goodpoints, raising a clear error if unavailable."""
    try:
        from goodpoints import ctt  # noqa: PLC0415
    except ImportError:
        msg = (
            "The 'goodpoints' package is required for MMD. "
            "Install with: pip install trustyai-service[mmd]"
        )
