...
The KS test is a non-parametric test that compares two distributions by
measuring the maximum distance between their cumulative distribution
functions.

This module provides the exact KS test. For approximate/streaming
versions, see the approx_ks_test module.
"""
...
class KolmogorovSmirnov:
    ...
    def kstest(
        ...
        result = ks_2samp(reference_data, current_data)
