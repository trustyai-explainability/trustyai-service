...
@router.post(routes.DRIFT_FOURIER_MMD.compute, response_model=None)
...
@router.get(routes.DRIFT_FOURIER_MMD.definition)
...
@router.post(routes.DRIFT_FOURIER_MMD.request, response_model=None)
...
@router.delete(routes.DRIFT_FOURIER_MMD.request, response_model=None)
...
@router.get(routes.DRIFT_FOURIER_MMD.requests, response_model=None)
