...
@router.post(routes.BATCH_MEAN.compute)
...
@router.get(routes.BATCH_MEAN.definition)
...
@router.post(routes.BATCH_MEAN.definition)
...
@router.post(routes.BATCH_MEAN.request)
...
@router.delete(routes.BATCH_MEAN.request)
...
@router.get(routes.BATCH_MEAN.requests)
...
@router.post(routes.IDENTITY.compute, deprecated=True)
...
@router.get(routes.IDENTITY.definition, deprecated=True)
...
@router.post(routes.IDENTITY.definition, deprecated=True)
...
@router.post(routes.IDENTITY.request, deprecated=True)
...
@router.delete(routes.IDENTITY.request, deprecated=True)
...
@router.get(routes.IDENTITY.requests, deprecated=True)
