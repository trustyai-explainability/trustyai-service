...
from trustyai_service.core.metrics.drift.mmd import MMD
...
class TestMMDACTT:
    ...
    def test_return_structure(self) -> None:
        ...
        # Verify drift_detected matches p_value <= alpha invariant
        assert result["drift_detected"] == (result["p_value"] <= result["alpha"])
