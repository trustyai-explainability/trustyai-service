...
def make_compute_empty_reference_data_test(
    ...
    """Create a test for compute endpoint when reference data is empty.
...
def make_compute_empty_current_data_test(
    ...
    """Create a test for compute endpoint when current data is empty.
...
def make_list_endpoint_scheduler_unavailable_test(
    ...
    """Create a test for list endpoint when scheduler is unavailable.
...
def make_compute_generic_exception_test(
    ...
    """Create a test for compute endpoint generic exception handling.
