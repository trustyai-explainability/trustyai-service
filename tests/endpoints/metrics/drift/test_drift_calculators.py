...
class TestCompareMeansCalculator:
    ...
    @patch("src.endpoints.metrics.drift.compare_means.get_data_source")
    @pytest.mark.asyncio
...
class TestKSTestCalculator:
    ...
    @patch("src.endpoints.metrics.drift.kolmogorov_smirnov.get_data_source")
    @pytest.mark.asyncio
    async def test_returns_named_values(self, mock_get_ds: MagicMock) -> None:
...
class TestJensenShannonCalculator:
    ...
    @patch("src.endpoints.metrics.drift.jensen_shannon.get_data_source")
    @pytest.mark.asyncio
    async def test_returns_named_values(self, mock_get_ds: MagicMock) -> None:
