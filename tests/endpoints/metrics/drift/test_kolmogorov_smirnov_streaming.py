...
import trustyai_service.endpoints.metrics.drift.kolmogorov_smirnov_streaming as ks_module
...
class TestKSTestStreamingEndpoints:
    ...
    test_compute_endpoint_pandas = factory.make_compute_endpoint_test(
        ...
        module_path="trustyai_service.endpoints.metrics.drift.kolmogorov_smirnov_streaming",
    ...
    test_compute_missing_fit_columns_derives_from_metadata = factory.make_compute_endpoint_test(
        metric_name="KSTestStreaming",
        module_path="trustyai_service.endpoints.metrics.drift.kolmogorov_smirnov_streaming",
        endpoint_path="/metrics/drift/ksteststreaming",
        client=client,
    ...
    test_schedule_missing_fit_columns_derives_from_metadata = factory.make_schedule_endpoint_test(
        metric_name="KSTestStreaming",
        module_path="trustyai_service.endpoints.metrics.drift.kolmogorov_smirnov_streaming",
        endpoint_path="/metrics/drift/ksteststreaming/request",
        client=client,
