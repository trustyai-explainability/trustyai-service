...
class TestReconcilerMatcher:
    ...
    def test_reconciler_matcher_initialization(self) -> None:
    ...
    def test_reconciler_matcher_decorator_functionality(self) -> None:
    ...
    def test_multiple_reconciler_matchers(self) -> None:
        ...
        assert InputField._reconciler_matcher.name_provider == "get_input_name"  # type: ignore[attr-defined]
        assert OutputField._reconciler_matcher.name_provider == "get_output_name"  # type: ignore[attr-defined]
        assert InputField._reconciler_matcher != OutputField._reconciler_matcher  # type: ignore[attr-defined]

    def test_reconciler_matcher_with_none_name_provider(self) -> None:
        """Test ReconcilerMatcher with None name provider."""
        with pytest.raises(ValueError, match=r"."):
            ReconcilerMatcher(None)  # type: ignore[arg-type]
