import pytest
from src.service.prometheus.metric_value_carrier import MetricValueCarrier, UnsupportedOperationException
...
class TestMetricValueCarrier:
    ...
    def test_single_value_construction(self):
        ...
        with pytest.raises(UnsupportedOperationException, match="must be accessed via .get_named_values()"):
