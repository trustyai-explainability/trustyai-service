...
class TestDataSource:
    ...
    def mock_model_data(self) -> Mock:
        ...
        mock.column_names = AsyncMock(return_value=(
            ["feature1", "feature2"], 
            ["target"], 
            ["metadata1"]
        ))
        mock.data = AsyncMock(return_value=(
            [[1, 2], [3, 4]], 
            [[0], [1]], 
            [["meta1"], ["meta2"]]
        ))
    ...
    def sample_metadata(self) -> StorageMetadata:
        ...
        output_items = {
            "target": SchemaItem(DataType.DOUBLE, "target", 0)
        }
    ...
    def test_get_dataframe_with_batch_size_success(self, mock_model_data_class: Mock, data_source: DataSource, mock_model_data: Mock) -> None:
    ...
    @patch('src.service.data.datasources.data_source.ModelData')
    def test_get_dataframe_default_batch_size(self, mock_model_data_class: Mock, data_source: DataSource, mock_model_data: Mock) -> None:
    ...
    @patch('src.service.data.datasources.data_source.ModelData')
    def test_get_dataframe_handles_exceptions(self, mock_model_data_class: Mock, data_source: DataSource) -> None:
        ...
        with pytest.raises(DataframeCreateException, match="Error creating dataframe for model=test_model"):
            data_source.get_dataframe("test_model")
    
    @patch('src.service.data.datasources.data_source.ModelData')
    def test_get_organic_dataframe_filters_unlabeled(self, mock_model_data_class: Mock, data_source: DataSource, mock_model_data: Mock) -> None:
    ...
    @patch('src.service.data.datasources.data_source.ModelData')
    def test_get_metadata_creates_and_caches(self, mock_model_data_class: Mock, data_source: DataSource, mock_model_data: Mock) -> None:
    ...
    @patch('src.service.data.datasources.data_source.ModelData')
    def test_get_metadata_handles_exceptions(self, mock_model_data_class: Mock, data_source: DataSource) -> None:
    ...
    def test_has_metadata_true(self, data_source: DataSource, sample_metadata: StorageMetadata) -> None:
    ...
    @patch('src.service.data.datasources.data_source.ModelData')
    def test_has_metadata_false(self, mock_model_data_class: Mock, data_source: DataSource) -> None:
    ...
    def test_get_num_observations(self, data_source: DataSource, sample_metadata: StorageMetadata) -> None:
    ...
    def test_has_recorded_inferences(self, data_source: DataSource, sample_metadata: StorageMetadata) -> None:
    ...
    def test_get_verified_models_from_known(self, data_source: DataSource, sample_metadata: StorageMetadata) -> None:
    ...
    @patch('src.service.data.datasources.data_source.ModelData')
    def test_get_verified_models_discovers_from_storage(self, mock_model_data_class: Mock, data_source: DataSource, mock_model_data: Mock) -> None:
    ...
    def test_has_ground_truths(self, data_source: DataSource, sample_metadata: StorageMetadata) -> None:
    ...
    @patch('src.service.data.datasources.data_source.ModelData')
    def test_get_ground_truths(self, mock_model_data_class: Mock, data_source: DataSource, mock_model_data: Mock) -> None:
    ...
    @patch('src.service.data.datasources.data_source.ModelData')
    def test_batch_size_calculation_with_limited_data(self, mock_model_data_class: Mock, data_source: DataSource, mock_model_data: Mock) -> None:
