...
class TestFlagDefaults:
    ...
    def test_drift_fourier_mmd_enabled_by_default(self) -> None:
        assert feature_flags.ENDPOINTS["drift_fourier_mmd"] is True

    def test_drift_approx_ks_test_enabled_by_default(self) -> None:
        assert feature_flags.ENDPOINTS["drift_approx_ks_test"] is True
