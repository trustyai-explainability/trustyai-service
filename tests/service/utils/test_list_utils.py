...
class TestGetListShape:
    ...
    def test_2d_list(self) -> None:
        """Test shape of 2D list."""
        lst = [[1, 2], [3, 4], [5, 6]]
        assert get_list_shape(lst) == [3, 2]

    def test_3d_list(self) -> None:
...
class TestSerializationReExports:
    ...
    def test_serialize_rows_is_callable(self) -> None:
        """Test serialize_rows is available."""
        assert callable(serialize_rows)

    def test_deserialize_rows_is_callable(self) -> None:
    ...
    def test_basic_roundtrip(self) -> None:
        ...
        assert len(deserialized) == EXPECTED_DESERIALIZED_ROW_COUNT
